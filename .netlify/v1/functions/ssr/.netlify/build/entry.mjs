...
import { manifest } from './manifest_BFGFheMh.mjs';
import { onRequest } from './_astro-internal_middleware.mjs';
import { createExports } from '@astrojs/netlify/ssr-function.js';

const serverIslandMap = new Map([
	['CartModal', () => import('./chunks/CartModal_ClxfBAf7.mjs')],
	['GoogleSignin', () => import('./chunks/GoogleSignin_CvutSNVO.mjs')],
	['Cart', () => import('./chunks/Cart_By0Zt61X.mjs')],
]);;
...
const _args = {
    "middlewareSecret": "2dede4b1-3727-437b-b8b3-e37066216e02"
};
