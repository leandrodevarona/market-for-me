import { c as createComponent, r as renderTemplate, m as maybeRenderHead, a as renderComponent, b as createAstro, d as addAttribute } from '../../../chunks/astro/server_BYO_c3aR.mjs';
import 'kleur/colors';
import { $ as $$GenericFormMarket, b as $$FormWarning, a as $$PublishMarket } from '../../../chunks/PublishMarket_U1HD6PfI.mjs';
/* empty css                                            */
import { $ as $$Icon } from '../../../chunks/Icon_BDERPYzh.mjs';
import { R as Routes } from '../../../chunks/routes_DK5zeVL6.mjs';
import { $ as $$AdminLayout } from '../../../chunks/AdminLayout_CW51NEtJ.mjs';
import { g as getMarketById, a as getMarkets } from '../../../chunks/markets_BsxLjTlS.mjs';
import { a as actions } from '../../../chunks/_astro_actions_DakPf4Hc.mjs';
import 'clsx';
import { Currency } from '@prisma/client';
import { i as isInputError } from '../../../chunks/shared_CGRRXZng.mjs';
...
Precio
<input class="secondary_text__input astro-ls27w35s" type="number" name="price" required${addAttribute(0, "min")} step=".01"${addAttribute(product.price, "value")}> </label> ${inputErrors.price && renderTemplate`<p class="error astro-ls27w35s">${inputErrors.price.join(",")}</p>`} ${renderComponent($$result, "Currencies", $$Currencies, { "value": product.currency, "class": "astro-ls27w35s" })} ${inputErrors.currency && renderTemplate`<p class="error astro-ls27w35s">${inputErrors.currency.join(",")}</p>`} </section> <section class="astro-ls27w35s"> <label class="astro-ls27w35s">
Descripción
