import { c as createComponent, r as renderTemplate, a as renderComponent, b as createAstro, m as maybeRenderHead, d as addAttribute, e as renderSlot } from './astro/server_DNQ7agjQ.mjs';
import 'kleur/colors';
import { $ as $$Layout } from './Layout_Cg4yLPd6.mjs';
...
const $$DeployedMarketInfo = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const iconTitle = isDeployed ? "Este mercado ya ha sido desplegado" : "Este mercado no ha sido desplegado a\xFAn";
...
const $$SidebarMarkets = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<details class="sidebar_markets astro-ahm33lyj"> <summary class="astro-ahm33lyj">
Mercados
