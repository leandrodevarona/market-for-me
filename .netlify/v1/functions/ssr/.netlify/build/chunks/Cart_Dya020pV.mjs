...
import 'kleur/colors';
import 'clsx';
import { g as getCartItems } from './cart_aGo_O-Lf.mjs';
...
const $$Cart = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "OpenModal", $$OpenModal, { "modalId": "cart", "class": "cart astro-bru5lpaf" }, { "default": ($$result2) => renderTemplate` ${renderComponent($$result2, "Icon", $$Icon, { "name": "mdi:cart-outline", "size": 30, "class": "astro-bru5lpaf" })} ${maybeRenderHead()}<div class="cart_amount astro-bru5lpaf">${cartItems?.length || 0}</div> ` })} `;
