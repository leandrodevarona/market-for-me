import { c as createComponent, r as renderTemplate, m as maybeRenderHead, d as addAttribute, a as renderComponent, e as renderSlot, b as createAstro, f as defineStyleVars, g as renderHead } from './astro/server_BYO_c3aR.mjs';
import 'kleur/colors';
import { $ as $$Icon } from './Icon_BDERPYzh.mjs';
/* empty css                         */
import $$GoogleSignin from './GoogleSignin_DtTi8_hw.mjs';
import 'clsx';
import $$Cart from './Cart_C2vldMsz.mjs';

const $$Astro$3 = createAstro();
const $$Modal = createComponent(($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro$3, $$props, $$slots);
  Astro2.self = $$Modal;
  const { id, class: className, style, title, backHref } = Astro2.props;
