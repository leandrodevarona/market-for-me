...
import $$Cart from './Cart_Dya020pV.mjs';
...
</span> <div class="cart_resume__subtotal astro-au3vpgvh"> <span class="astro-au3vpgvh">${subtotalByCurrency.USD}</span> <span class="astro-au3vpgvh">${subtotalByCurrency.EUR}</span> <span class="astro-au3vpgvh">${subtotalByCurrency.CUP}</span> </div> </div> `;
