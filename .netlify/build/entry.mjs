...
const _page8 = () => import('./pages/markets/_marketid_.astro.mjs');
const _page9 = () => import('./pages/products/_productid_.astro.mjs');
...
const pageMap = new Map([
    ...
    ["src/pages/markets/[marketId].astro", _page8],
    ["src/pages/products/[productId].astro", _page9],
...
const _args = {
    "middlewareSecret": "ae1533f8-87c2-4e99-8143-ae2ad09ed2ae"
};
