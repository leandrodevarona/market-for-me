...
import { manifest } from './manifest_CH3enifT.mjs';
import { onRequest } from './_astro-internal_middleware.mjs';
import { createExports } from '@astrojs/netlify/ssr-function.js';

const serverIslandMap = new Map([
	['GoogleSignin', () => import('./chunks/GoogleSignin_NV_RehS7.mjs')],
	['Cart', () => import('./chunks/Cart_CO78hU_R.mjs')],
]);;
...
const _args = {
    "middlewareSecret": "abc36e2e-9e14-4a2c-be4c-22846b1fd57f"
};
