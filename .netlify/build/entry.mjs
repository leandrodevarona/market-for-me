...
import { manifest } from './manifest_Cei_DHaA.mjs';
import { onRequest } from './_astro-internal_middleware.mjs';
import { createExports } from '@astrojs/netlify/ssr-function.js';

const serverIslandMap = new Map([
	['GoogleSignin', () => import('./chunks/GoogleSignin_DtTi8_hw.mjs')],
	['Cart', () => import('./chunks/Cart_C2vldMsz.mjs')],
]);;
...
const _args = {
    "middlewareSecret": "ae41cc8c-c689-43b7-8c0e-910ea6393f0e"
};
