import { c as createComponent, r as renderTemplate, m as maybeRenderHead, a as renderComponent, b as createAstro, d as addAttribute } from '../../../chunks/astro/server_DNQ7agjQ.mjs';
import 'kleur/colors';
import { $ as $$GenericFormMarket, a as $$FormWarning } from '../../../chunks/FormWarning_B9eojN7K.mjs';
/* empty css                                            */
import { $ as $$Icon } from '../../../chunks/GoogleSignin_B4lX6aU6.mjs';
import { R as Routes } from '../../../chunks/routes_DK5zeVL6.mjs';
import { $ as $$AdminLayout } from '../../../chunks/AdminLayout_B83AlOKK.mjs';
import { g as getMarketById, a as getMarkets } from '../../../chunks/markets_BsxLjTlS.mjs';
import { a as actions } from '../../../chunks/_astro_actions_BNIfTu6q.mjs';
import 'clsx';
import { Currency } from '@prisma/client';
import { i as isInputError } from '../../../chunks/shared_jip68GMR.mjs';
...
const $$UpdateMarket = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<div class="update_market__form astro-ql45oi6p"> ${renderComponent($$result, "GenericFormMarket", $$GenericFormMarket, { "market": market, "class": "astro-ql45oi6p" })} ${renderComponent($$result, "FormWarning", $$FormWarning, { "class": "astro-ql45oi6p" })} </div> `;
...
const $$Currencies = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<label>
Moneda
<select name="currency"> ${Object.values(Currency).map((currency) => renderTemplate`<option${addAttribute(currency, "value")}${addAttribute(currency === value, "selected")}> ${currency} </option>`)} </select> </label> `;
}, "C:/Users/leand/Proyectos/market-for-me/src/components/admin/markets/products/selects/Currencies.astro", void 0);
...
const $$DeleteProduct = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<form class="delete_product__form astro-qhbpsv6r" method="POST"${addAttribute(actions.deleteProduct, "action")}> <input type="text" name="productId"${addAttribute(productId, "value")} hidden class="astro-qhbpsv6r"> <button class="astro-qhbpsv6r">Eliminar</button> </form> `;
...
Precio
<input class="secondary_text__input astro-ls27w35s" type="number" name="price" required${addAttribute(0, "min")}${addAttribute(product.price, "value")}> </label> ${inputErrors.price && renderTemplate`<p class="error astro-ls27w35s">${inputErrors.price.join(",")}</p>`} ${renderComponent($$result, "Currencies", $$Currencies, { "value": product.currency, "class": "astro-ls27w35s" })} ${inputErrors.currency && renderTemplate`<p class="error astro-ls27w35s">${inputErrors.currency.join(",")}</p>`} </section> <section class="astro-ls27w35s"> <label class="astro-ls27w35s">
Descripción
