...
import 'kleur/colors';
import { $ as $$GenericFormMarket, a as $$PublishMarket } from '../../../chunks/PublishMarket_8znk0MbV.mjs';
/* empty css                                            */
import { $ as $$Icon } from '../../../chunks/Icon_Ch9NK6yf.mjs';
import { R as Routes } from '../../../chunks/routes_DG_8Jzi8.mjs';
import { $ as $$AdminLayout } from '../../../chunks/AdminLayout_ClDLd98s.mjs';
import { g as getMarketById } from '../../../chunks/markets_C8fXSG5n.mjs';
import { a as actions } from '../../../chunks/_astro_actions_hWnmEwMn.mjs';
import 'clsx';
...
const $$Currencies = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<label class="currency astro-khobsngf">
Moneda
<select name="currency" class="astro-khobsngf"> ${Object.values(Currency).map((currency) => renderTemplate`<option${addAttribute(currency, "value")}${addAttribute(currency === value, "selected")} class="astro-khobsngf"> ${currency} </option>`)} </select> </label> `;
