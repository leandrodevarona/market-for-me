import { c as createComponent, r as renderTemplate, m as maybeRenderHead, a as renderComponent } from '../../../chunks/astro/server_DNQ7agjQ.mjs';
import 'kleur/colors';
...
const $$CreateMarket = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${maybeRenderHead()}<div class="create_market__form astro-vkwwdw4c"> ${renderComponent($$result, "GenericFormMarket", $$GenericFormMarket, { "class": "astro-vkwwdw4c" })} ${renderComponent($$result, "FormWarning", $$FormWarning, { "class": "astro-vkwwdw4c" })} </div> `;
